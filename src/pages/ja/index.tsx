...
export default function CoinBypassHome() {
  return (
    <>
      <Head
        siteId="coinbypass"
        title="CoinBypass — コイン決済 + 仮想口座精算 | USDTチャージステーション開業"
        description="事業者本人の口座なしで、コイン（USDT）で決済を受け取り仮想口座で精算。USDTチャージステーションをレンタル — インフラ・決済・精算はCoinBypassが提供します。USDTチャージ・コイン決済ガイドも掲載。"
        keywords="チャージステーション レンタル, 仮想口座精算, コイン決済, USDT決済, 決済代行, CoinBypass, USDTチャージ, TRC20, ステーブルコイン, 暗号資産決済"
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
                ...
                <br />
                <span className="text-white">自分だけのUSDTチャージステーション運営</span>
              </h1>

              <p className="text-xl text-coinbypass-muted-foreground max-w-3xl mx-auto mb-10">
                事業者本人の口座なしで、コイン（USDT）で決済を受け取り仮想口座で精算。
                <br className="hidden md:block" />
                インフラ・決済・精算はCoinBypassが提供します。
              </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                自分だけの<span className="text-coinbypass-primary">チャージステーション</span>を運営
              </h2>
              <p className="text-xl text-coinbypass-muted-foreground max-w-2xl mx-auto">
                事業者本人の口座なしで、コイン決済を受け取り仮想口座で精算できます。
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { icon: "🏦", title: "口座なしで精算", desc: "USDTで決済を受け取り仮想口座で精算 — 別途の入金口座は不要" },
                { icon: "⚡", title: "即時発行", desc: "申請後すぐにチャージステーションをオープン — 開発・サーバー準備不要" },
        ...
        <section className="py-12 text-center">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-coinbypass-muted border border-coinbypass-border">
              ...
              <span className="text-sm text-coinbypass-muted-foreground">利用者向け — USDT充電 · コイン決済 · 決済迂回ガイド</span>
            </div>
          </div>
        </section>
